          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:w-2/5">
              <div className="rounded-3xl overflow-hidden">
                <Image
                  src={reservation.imageUrl || "/placeholder.svg?height=300&width=300"}
            ...
            <div className="md:w-3/5">
              ...
              <div className="space-y-3 text-lg">
                ...
                <p>
                  <span className="text-[#0079c2]">Data de entrada:</span> {reservation.startDate}
                </p>
                <p>
                  <span className="text-[#0079c2]">Data de saída:</span> {reservation.endDate}
                </p>
                <p className="text-2xl mt-8">
                  <span className="text-[#0079c2]">Total:</span> {formatCurrency(reservation.price)}
                </p>
              </div>
            </div>
          </div>
