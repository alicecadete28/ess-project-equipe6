...
When uma requisição GET for enviada para "/api/favorites/12732" com o corpo da requisição sendo um JSON com id "12732" e phone "98171-2882"
...
Scenario: Atualizar a lista de favoritos de um usuário com sucesso
Given o PfRepository tem um usuário com id "12732" e phone "98171-2882"
When uma requisição PATCH for enviada para "/api/favorites/12732" com o corpo da requisição sendo um JSON contendo id "12732", phone "98171-2882" e uma lista de favoritos atualizada
Then o status da resposta deve ser "200"
And a resposta deve ter um JSON confirmando a atualização da lista de favoritos

Scenario: Falha ao atualizar a lista de favoritos de um usuário
Given o PfRepository não tem um usuário com cpf "99999999" e phone "00000-0000"
When uma requisição PATCH for enviada para "/api/favorites/id" com o corpo da requisição sendo um JSON contendo cpf "99999999", phone "00000-0000" e uma lista de favoritos
Then o status da resposta deve ser "404"
