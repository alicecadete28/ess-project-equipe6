Feature: Reserva de Quartos
   ...
   Scenario: Criar uma reserva com sucesso
    ...
    And o JSON da resposta deve conter pf_id "user123", room_id "room456", check_in "2025-03-01", check_out "2025-03-05", guests "2", total "500", status "pending", rating stars "0" e rating comment ""
...
#     And o JSON da resposta deve conter a mensagem "Token not provided"
   ...
   Scenario: Atualizar as datas de uma reserva existente
    ...
    When uma requisição PATCH for enviada para "/api/reservations/123/dates" com check_in "2025-04-01" e check_out "2025-04-10"
  ...
  Given uma reserva existe no sistema com id "123"
  When uma requisição PATCH for enviada para "/api/reservations/123/guests" com guests "4"
  Then o status da resposta deve ser "200"
