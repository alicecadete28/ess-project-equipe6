...
jest.mock('../../src/repositories/pj.repository'); // ✅ Garante um mock completo do módulo

describe('FilterController', () => {
    let request = supertest(app);
    let mockRoomRepository: RoomRepository;
    let mockRoomService: RoomService;
    let mockPjRepository: jest.Mocked<PjRepository>;  
  ...
  beforeEach(() => {
    ...
    mockPjRepository = {
      ...
      update: jest.fn(),
      delete: jest.fn(),
    } as unknown as jest.Mocked<PjRepository>;
    mockRoomService = new RoomService(mockRoomRepository, mockPjRepository); 
